...
import { formatDateTime, computeValidation, type ValidationResult } from "./prescriptionValidationUtils";
    ...
    <div className="max-w-6xl mx-auto p-4 space-y-6">
      ...
      <div className="bg-white rounded-2xl border shadow-sm">
        ...
        <div className="p-5 grid grid-cols-2 sm:grid-cols-4 gap-4 text-sm">
          ...
          <KV label="Submission Time" value={formatDateTime(viewData.createdAt)} />
