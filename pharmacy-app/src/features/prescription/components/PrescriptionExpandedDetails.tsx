...
import type { PrescriptionSummaryDto, PrescriptionDetailsDto, PrescriptionMedicineDto } from "@prescription/prescription.types";
...
export default function PrescriptionExpandedDetails({
  ...
  if (!details) {
    return <div className="p-8 text-gray-500">Loading prescription details...</div>;
  }
  ...
  return (
    <div className="bg-gradient-to-br from-slate-50 via-blue-50 to-emerald-50 p-8">
        ...
        <div className="col-span-4 flex">
          <div className="rounded-2xl border border-blue-200/70 bg-white shadow-md shadow-blue-100/60 overflow-hidden flex-1 flex flex-col">
            <div className="bg-gradient-to-r from-blue-600 to-indigo-600 px-5 py-4 flex items-center gap-3">
              ...
              <div>
                <div className="text-sm font-bold text-white">Patient Information</div>
                <div className="text-xs text-blue-100/90">Demographics & Records</div>
              </div>
            </div>
            ...
            <div className="p-5 space-y-4 divide-y flex-1 min-h-0 max-h-96 overflow-auto">
              {patient ? (
                ...
                <div className="text-gray-500">Patient details not available.</div>
              )}
            </div>
          </div>
        </div>
          ...
          <div className="rounded-2xl border border-emerald-200/70 bg-white shadow-md shadow-emerald-100/60 overflow-hidden flex-1 flex flex-col">
            <div className="bg-gradient-to-r from-emerald-600 to-teal-600 px-5 py-4 flex justify-between items-center">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-sm font-bold text-white">Prescribed Medications</div>
                  <div className="text-xs text-emerald-100/90">Complete medication list</div>
                </div>
              </div>
            ...
            <div className="p-5 space-y-5 flex-1 min-h-0 max-h-96 overflow-auto">
              {details.medicines?.map((med: PrescriptionMedicineDto, idx) => (
                <div
                ...
                >
                  <div className="flex justify-between mb-3">
                    <div>
                      ...
                      <div className="text-sm font-semibold text-green-600">{med.strength}</div>
                    </div>
                  ...
                  {med.instruction && (
                    <div className="pt-3 border-t">
                      ...
                      <div className="text-sm text-gray-700">{med.instruction}</div>
                    </div>
                  )}
                </div>
              ))}
      ...
      {/* row is currently unused but kept in props for future extension */}
      {/* e.g. row.status, row.prescriberName etc */}
