...
//                 Search by name/phone in the left panel
//               </li>
//               <li className="flex gap-2">
//                 <span className="mt-[7px] h-1.5 w-1.5 rounded-full bg-gray-400" />
...
//               <li className="flex gap-2">
//                 <span className="mt-[7px] h-1.5 w-1.5 rounded-full bg-gray-400" />
//                 Use <span className="font-medium text-gray-800">Add New Patient</span> if not found
//               </li>
//             </ul>
//           </div>
...
//                         {rx.medicationCount} medication(s)
//                       </div>
//                     </div>

//                     <span
//                       className={clsx("px-3 py-1 rounded-full text-sm", {
//                         "bg-yellow-100 text-yellow-700": rx.status === "Created",
...
import { FileText, UserCircle2, CalendarDays, Pill } from "lucide-react";
...
function PrescriptionItem({ rx }: { rx: PrescriptionSummaryDto }) {
  ...
  const reviewNeeded = rx.validationSummary?.requiresReview;
