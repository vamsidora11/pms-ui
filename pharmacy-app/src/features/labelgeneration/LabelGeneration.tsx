...
export default function LabelGenerationPage() {
  ...
  const handlePrint = useCallback(() => {
    ...
    if (labels.length === 0) {
      alert('No labels to print. Please select a prescription first.');
      return;
    }
    ...
    try {
          ...
          <head>
            ...
            <style>
              * {
              ...
              /* Scale down the label for printing */
              .print-label {
              ...
              .print-label > div:first-child > div:first-child {
                font-size: 13px !important;
                font-weight: bold;
              }
              
              .print-label .border-b-2 {
                border-bottom: 2px solid #333 !important;
                padding-bottom: 8px !important;
                margin-bottom: 8px !important;
              }
              
              .print-label .border-t-2 {
                border-top: 2px solid #333 !important;
                padding-top: 8px !important;
                margin-top: 8px !important;
              }
              
              .print-label .border-t {
                border-top: 1px solid #ccc !important;
              }
              
              .print-label .border-gray-300 {
      ...
      alert('An error occurred while preparing labels for printing');
      setIsPrinting(false);
    }
  }, [selected]);
  ...
  const handleDownload = useCallback(async () => {
    ...
    try {
      ...
      const gap = 10; // 1cm gap between labels
      ...
      for (let i = 0; i < labels.length; i++) {
        ...
        // Try to fit 2 labels per row if there's space
