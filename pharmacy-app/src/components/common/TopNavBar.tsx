...
//   );
// }
// Minimal Topbar example with user display and placeholder actions.
// Reasoning:
// - Demonstrates passing user to layout components and how auth info can drive UI.
...
export function Topbar({ user }: { user: User }) {
  return (
    <header className="h-14 bg-white border-b flex items-center justify-between px-4">
      <div className="font-semibold">Pharmacy Management</div>
