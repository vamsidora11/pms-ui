...
// import type { CreatePatientRequest, UpdatePatientRequest, PatientDetailsDto, PatientSummaryDto } from "../store/patient/patienttype";
...
//   const response = await api.get(ENDPOINTS.patientSearch, { params: { query } });
